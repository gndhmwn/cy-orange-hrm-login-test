...
describe('Login Functionality - OrangeHRM', () => {
    ...
    describe('Security Test Cases', () => {
        it('TC-LOGIN-009: Login dengan payload SQL injection pada username dan password valid', () => {
            cy.fixture('login').then((data) => {
                loginPage.login(
        ...
        it('TC-LOGIN-010: Login dengan payload XSS pada username dan password valid', () => {
            cy.fixture('login').then((data) => {
                loginPage.login(
